...
import bean.CoreTeam2;
import bean.CoreTeam3;
...
public class Step2Test {
    ...
    @Test
    public void test1() throws NoSuchMethodException, SecurityException, IllegalArgumentException,
            InvocationTargetException {
    ...
    @Test
    public void test2() throws NoSuchMethodException, SecurityException, IllegalArgumentException,
            InvocationTargetException {
        CoreTeam1 coreTeam1 = (CoreTeam1)beanFactory.getBean("coreTeam1");
        CoreTeam2 coreTeam2 = (CoreTeam2)beanFactory.getBean("coreTeam2");
        CoreTeam3 coreTeam3 = (CoreTeam3)beanFactory.getBean("coreTeam3");
