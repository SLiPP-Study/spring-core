package analyze.context.support;

import analyze.beans.BeanWrapper;
import analyze.beans.BeansException;
import analyze.beans.NoSuchBeanDefinitionException;
import analyze.beans.factory.*;
import analyze.beans.factory.config.BeanDefinition;
import analyze.beans.factory.config.ConfigurableBeanFactory;
import analyze.beans.factory.support.ChildBeanDefinition;
import analyze.beans.factory.support.RootBeanDefinition;
...
public abstract class AbstractBeanFactory implements ConfigurableBeanFactory {
    ...
    public Object getBean(String name) throws BeansException{
        ...
        if (sharedInstance != null) {
            ...
            }catch(analyze.beans.factory.NoSuchBeanDefinitionException ex){
